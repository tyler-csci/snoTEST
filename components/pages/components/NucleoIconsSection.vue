        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    ...
                    <a href="nucleo-icons.html" class="btn btn-success btn-round btn-lg" target="_blank">View Demo Icons</a>
                    <a href="https://nucleoapp.com/?ref=1712" class="btn btn-success btn-simple btn-round btn-lg" target="_blank">View All Icons</a>
                </div>
                <div class="col-lg-6 col-md-12">
